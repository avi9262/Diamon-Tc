        ...
        $.ajax({
          ...
          success: function (response) {
            ...
            if (firstGame && firstGame.stage === list_orders[0].period) {
              ...
              var popwhitebackgrounf = document.getElementById("popwhitebackgrounf");
              ...
              if (firstGame.get == 0) {
                popwhitebackgrounf.src = '/loss.png'
                myModalheader.innerHTML = "Loss try again";
                myModal_result.innerHTML = "₹" + firstGame.money;
              } else {
                  popwhitebackgrounf.src = '/missningBg-9deda6ac.png'
              ...
              lottery_result.innerHTML = "Lottery Result:<span class='btn-boox "+xclass+"'>" + color + "</span><span class='btn-boox "+xclass+"'>" + firstGame.result + "</span><span class='btn-boox "+xclass+"'>" + type + "</span>";
            }
...
function showListOrder(list_orders, x) {
  ...
  let htmls = "";
  let result = list_orders.map((list_orders) => {
      let className;  // Use className to avoid conflicts with reserved keywords

    if (list_orders.amount == 0) {
        className = 'xredvioletcolor';
    } else if (list_orders.amount == 5) {
        className = 'xgreenvioletcolor';
    } else if (list_orders.amount % 2 == 1) {
        className = 'green';
    ...
    return (htmls += `
                    <div data-v-a9660e98="" class="c-tc item van-row">
                        ...
                        <div data-v-a9660e98="" class="van-col van-col--5">
                            <div data-v-a9660e98="" class="c-tc goItem">
                                <!---->
                                <span data-v-a9660e98="" class="${className}"> ${list_orders.amount} </span>
                            </div>
                        </div>
                        <div data-v-a9660e98="" class="van-col van-col--5">
                            <div data-v-a9660e98="" class="c-tc goItem">
                        ...
                        <div data-v-a9660e98="" class="details" style="display: none">
                            ...
                            <div data-v-a9660e98="" class="li c-row c-row-between c-row-middle">
                                ...
                                <div data-v-a9660e98="" class="li c-row c-row-between c-row-middle">
                                    ...
                                    <div data-v-a9660e98="">${list_orders.money + list_orders.fee}</div>
                                    </div>
                                    <div data-v-a9660e98="" class="li c-row c-row-between c-row-middle">
                                    ...
                                    <div data-v-a9660e98="">
                                        ...
                                        <div data-v-a9660e98="" style="display: inline-block; margin-left: 8px;">${list_orders.result == 0 ? "Purple" : list_orders.result == 5
                                         ? "Indigo" : list_orders.result % 2 == 0  ? "Red" : "Green"} </div>
                                        <div data-v-a9660e98="" style="display: inline-block; margin-left: 8px;">${list_orders.result < 5 ? "Small" : "Big"}</div>
                                    </div>
                                </div>
                                <div data-v-a9660e98="" class="li c-row c-row-between c-row-middle ">
